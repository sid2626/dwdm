...
CREATE TABLE FactMedicalTreatment (
    TreatmentKey INT PRIMARY KEY AUTO_INCREMENT,
    PatientKey INT NOT NULL,
    DoctorKey INT NOT NULL,
    TreatmentDateKey INT NOT NULL,
...
INSERT INTO FactPatientVisit (PatientKey, DoctorKey, DepartmentKey, DateKey, TotalCost, TotalRevenue) VALUES
(1, 1, 1, 1, 5000.00, 7000.00),
(2, 2, 2, 2, 2000.00, 3000.00),
(3, 3, 3, 3, 50.00, 100.00),
(4, 4, 4, 4, 100.00, 150.00);

INSERT INTO FactMedicalTreatment (PatientKey, DoctorKey, TreatmentDateKey, TreatmentCost, TreatmentType) VALUES
(1, 1, 1, 5000.00, 'Surgery'),
(2, 2, 2, 2000.00, 'Surgery'),
(3, 3, 3, 50.00, 'Preventive Care'),
(4, 4, 4, 100.00, 'Consultation');
